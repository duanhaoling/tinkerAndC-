...
@DefaultLifeCycle(application = "com.ldh.android.tinkerdemo.AppContext", flags = ShareConstants.TINKER_ENABLE_ALL)
public class AppContextLike extends DefaultApplicationLike {
    ...
    public void onBaseContextAttached(Context base) {
        ...
        AppContextUtil.application = getApplication();
        AppContextUtil.context = getApplication();
