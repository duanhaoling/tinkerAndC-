package com.ldh.android.tinkerdemo.util;

import com.ldh.android.tinkerdemo.AppContextLike;
import com.ldh.android.tinkerdemo.crash.TinkerUncaughtExceptionHandler;
...
public class TinkerManager {
    ...
    public static void setTinkerApplicationLike(AppContextLike appLike) {
     ...
     * @param appLike
     */
    public static void installTinker(AppContextLike appLike) {
        if (isInstalled) {
            TinkerLog.w(TAG, "install tinker, but has installed, ignore");
            return;
        }
